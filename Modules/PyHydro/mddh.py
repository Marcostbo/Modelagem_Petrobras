...
from Modules.PyHydro.pmo import pmo
from Modules.PyHydro.dadosgerais import dadosgerais
...
class mddh(object):
    ...
    def __init__(self, diretorio):
        ...
        # Cria Sistema
        self.submercado, self.intercambio, self.npmc = self.caso.le_sistema(self.submercado, self.intercambio, self.dger.NAnosEstudo, self.npmc)
