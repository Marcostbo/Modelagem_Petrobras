...
from Modules.PyHydro.term import term
from Modules.PyHydro.resequiv import resequiv
from Modules.PyHydro.submercado import submercado as subsist
from Modules.PyHydro.interc import interc
import numpy as np
import re
...
class pmo(object):
    ...
    def le_modif(self, conf, anoinicial, nanos):
        ...
        while i < len(arquivo)-1:
            ...
            while arquivo[i][1:6] != 'USINA' and encontrou:
                ...
                if i == len(arquivo):
                    break
        print('OK! Leitura do MODIF realizada com sucesso. (', nr_modificacoes, 'Usinas Hidraulicas Modificadas - ',i,'linhas lidas )')
        return conf
    ...
    def le_exph(self, conf, anoinicial, nanos):
        ...
        print('OK! Leitura do EXPH realizada com sucesso. (', nr_expansoes, 'Usinas Hidraulicas Expandidas - ', i, 'linhas lidas )')
        return(conf)
